...
List<OrderShipper2> orderShipper2FromJson(String str) => List<OrderShipper2>.from(json.decode(str).map((x) => OrderShipper2.fromJson(x)));

String orderShipper2ToJson(List<OrderShipper2> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
